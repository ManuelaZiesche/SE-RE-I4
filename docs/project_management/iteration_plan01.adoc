...
| Meeting mit Themenstellern | 11.12.2020 | Analysten haben detaillierte Fragen
...
| Essence Navigator | niedrig | 1 | erledigt | essence_navigator_images/Essence_Navigator_Iteration01.png[] | alle Teammitglieder | 1
