...
| Vision | hoch | 5 | erledigt| <<link:{docs-requirements}/technical_vision.adoc[]>>  | Kristina, Erik | 7
| Use  Cases | mittel | -- | erledigt | <<link:{docs-requirements}/use_case-model.adoc[]>> | Kristina und Erik |  ?
