...
*Use-Case 02*: Mitgliedaufnahme +
*Use-Case 03*: Einpflegung weiterer Informationen +
*Use-Case 04*: E-Mail Export mittels Thunderbird +
(*Use-Case*: Stimmzettelgenerierung zum Ausdruck für die Wahlen) +
(*Use-Case*: Workload erfassen +
*Use-Case*: Aufwandsentschädigung Berechnung aufgrund des Workloads +
