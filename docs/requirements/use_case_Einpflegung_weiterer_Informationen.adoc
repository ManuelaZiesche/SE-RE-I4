...
. Der Use Case beginnt, wenn der Admin den Tab "Kandidaten" auswählt
. Der Admin lädt die zugesendeten, unterschriebenen Dokumente hoch
. Desweiteren gibt er an, ob die Telefonummer des neuen Mitgliedes im Notfall an andere Mitglieder weitergegeben werden darf 
