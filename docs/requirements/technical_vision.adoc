...
<<<<<<< HEAD
|einfache Verwaltung der Kandidaten | Hoch | eigener "Kandidaten" Tab, in dem die Daten des Kandidaten angelegt, bearbeitet oder gelöscht werden können | xx
...
=======
|einfache Verwaltung der Kandidaten | Hoch | eigener "Kandidaten" Tap, in dem die Daten des Kandidaten (Name, Vorname, Wahldatum, E-Mail, Beschlussnummer) angelegt und bearbeitet werden können. Kandidaten können auch gelöscht werden. | xx
|wichtige und neue Informationen werden unter dem Tab Kandidaten angezeigt| Hoch| Wahldatum und Beschlussnummer der Kandidaten sind ersichtlich  |xx
...
>>>>>>> adaf453... stark überarbeitet #produktiv
|einfaches Mittel zur (Gruppen)-Kommunikation |Mittel |Mailverteiler oder Direktmail mittels Einbindung von Thunderbird| xx
|spezielle Informationen/Features nur von Admins einsehbar | Hoch |"Checklisten" und "Kandidaten" Tabs dürfen nur von Admins und nicht von Mitgliedern gesehen werden; Telefonnumer von anderen Mitgliedern dürfen auch nur Admins angezeigt werden | xx
...
|Organigramm erstellen | Niedrig | das  existierende Organigramm übersichtlicher gestalten | xx
