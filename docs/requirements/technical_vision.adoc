...
|einfache Verwaltung der Kandidaten | Hoch | eigener "Kandidaten" Tap, in dem die Daten des Kandidaten (Name, Vorname, Wahldatum, Beschlussnummer) angelegt, bearbeitet oder gelöscht werden können | xx
