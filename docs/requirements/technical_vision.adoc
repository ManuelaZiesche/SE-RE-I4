...
|Check-Listen für Angestellte | Hoch |für Admin/Angestellte des Stura werden einzelne Aufgaben automatisch nach Mitgliedsaufnahme angelegt, welche abgehakt werden können. Diese Aufgaben sind: die Einrichtung der Stura Karte für den Zugriff auf das A-Gebäude (Kartenleser); Ausgeben der Schlüssel für die passenden Räume; E-Mail (Datengeheimnis, Mitwirkungsordnung unterschreiben) versenden; Hochladen der ausgefüllten Unterlagen; Erfragung ob die Telefonnummer von neue Mitgliedern im Bedarfsfall weitergegeben werden kann; eintragen ob Telefonnummer weitergegeben werden darf  | xx
...
|Automatische Stimmzettelgenerierung | Mittel | Vor Wahl Stimmzettel zum Ausdrucken generieren|  xx
|Automatisierung der Mitgliederaufnahme nach der Wahl | Mittel |nach Wahl können Kandidaten mit einem Knopfdruck als Mitglied aufgenommen werden | xx
...
|Organigramm erstellen/übersichtlicher machen | Niedrig | die existierende Organigramm übersichtlicher gestalten | xx
