...
:docs-project_management-iteration_plans: {docs}/project_management/iteration_plans
...
<<<
include::{docs-architecture-Wireframes}/Mitglieder_bearbeiten_Dokumentenupload.jpg[]
// System-wide Requirements
<<<
...
// Projektplan
<<<
include::{docs-project_management}/project_plan.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
// Risikoliste
include::{docs-project_management}/risk_list.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
// Iteration 1
